 ...
 * 
 */
@ContextConfiguration(locations = { "file:src/main/resources/transportTier/ccsds-decoder.xml" })
public class ccsdsDecoderTest extends AbstractJUnit4SpringContextTests {
	protected static Logger logger = Logger.getLogger(ccsdsDecoderTest.class);
	...
	@Autowired
	protected CamelContext ccsdsDecoderContext = null;
	...
	public void initialize() throws Exception {
		...
		if (thisIsTheFirstRun) {
			...
			ccsdsDecoderContext.addRoutes(new RouteBuilder() {
